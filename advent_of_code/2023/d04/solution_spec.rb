    ...
    describe 'final result for pt1' do
      context 'with example input data' do
        it 'returns correct result' do
          expect(Solution.new(example_input).solution_pt1).to eq 13
        end
      end

      context 'with custom input data' do
        it 'returns correct result' do
          expect(Solution.new(custom_input).solution_pt1).to eq 23_673
        end
      end
    end
  end
...
example_input = <<~INPUT
            ...
            INPUT
          expect(
            Solution.new(example_input).solution_pt2
          ).to eq 30
        end
      end
      ...
      it 'returns correct result' do
        ...
        expect(Solution.new(example_input).solution_pt2).to eq 30
      end
    end
