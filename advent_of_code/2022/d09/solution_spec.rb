...
RSpec.describe 'Solutions' do
        ...
        describe 'HEAD and TAIL' do
          ...
          it 'moves head and tail correctly after 8th instruction(R 2)' do
            ...
            expect(tail.visited.uniq).to eq(
              [[0, 0], [0, 1], [0, 2], [0, 3], [-1, 4], [-2, 4], [-3, 4], [-4, 3], [-4, 2], [-3, 3], [-2, 3], [-2, 2],
               [-2, 1]]
            )
  ...
  describe 'Part 2' do
    ...
    context 'example input data' do
      it 'returns correct result' do
        expect(solution_pt2(large_example_input)).to eq 36
        expect(solution_pt2(example_input)).to eq 1
      end
    end

    context 'custom input data' do
      it 'returns correct result' do
        expect(solution_pt2(custom_input)).to eq 2482
      end
    end
  end
end
