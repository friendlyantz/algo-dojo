...
RSpec.describe 'Solutions' do
    ...
    describe 'final result for pt1' do
      context 'example input data' do
        it 'returns correct result' do
          expect(solution_pt1(example_input)).to eq 15
        end
      end

      context 'custom input data' do
        it 'returns correct result' do
          expect(solution_pt1(custom_input)).to eq 13_526
        end
      end
    end
  end
  ...
  describe 'Part 2' do
    ...
    context 'example input data' do
      it 'returns correct result' do
        expect(solution_pt2(example_input)).to eq 12
      end
    end
    ...
    context 'custom input data' do
      it 'returns correct result' do
        ...
        expect(solution_pt2(custom_input)).to eq 14_204
      end
    end
  end
end
